...
class GameLevel():
    ...
    def __showGamePanel(self, screen, tank_player1, tank_player2=None):
        ...
        # 玩家一操作提示
        player1_operate_tip = self.font.render('玩家一:', True, color_white)
        ...
        screen.blit(player1_state_tip, player1_state_tip_rect)
        player1_state_tip = self.font.render('坦克等级: %s' % tank_player1.tanklevel, True, color_white)
        player1_state_tip_rect = player1_state_tip.get_rect()
        player1_state_tip_rect.left, player1_state_tip_rect.top = self.width+5, self.height*17/30
        screen.blit(player1_state_tip, player1_state_tip_rect)
        # 玩家二状态提示
        player2_state_tip = self.font.render('玩家二状态:', True, color_white)
        ...
        screen.blit(player2_state_tip, player2_state_tip_rect)
        player2_state_tip = self.font.render('坦克等级: %s' % tank_player2.tanklevel, True, color_white) if tank_player2 else self.font.render('TLevel: None', True, color_white)
        player2_state_tip_rect = player2_state_tip.get_rect()
        player2_state_tip_rect.left, player2_state_tip_rect.top = self.width+5, self.height*21/30
        screen.blit(player2_state_tip, player2_state_tip_rect)
        # 当前关卡
        game_level_tip = self.font.render('游戏级别: %s' % self.gamelevel, True, color_white)
        ...
        # 剩余敌人数量
        remaining_enemy_tip = self.font.render('剩余敌人 : %s' % self.total_enemy_num, True, color_white)
